    ...
    <div className="min-h-screen flex items-center justify-center">
      ...
      sm:items-center flex-col-reverse items-start gap-3 sm:gap-10">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-gray-400">Indonesia</h3>
        </div>
      ...
      <div>
        <h1 className="text-4xl">Aisyah Nabillah</h1>
        ...
        via-sky-300 to-blue-500 font-bold opacity-90
          hover:opacity-100 transition-opacity">Contact Me{" "}
          </Link>{" "}
      ...
      <nav className="space-y-4">
        ...
        <div className="flex flex-col gap-3">
          ...
          border-gray-700/40 flex group items-center
          justify-between p-3 cursor-pointer transition-colors
          duration-200 ease-linear hover:bg-zinc-800/40
          rounded-lg">
          <span>About</span>
        ...
        <div className="flex flex-col gap-3">
          <Button
            asChild
            className="bg-black/30 w-full p-6 text-gray-300
                      border border-gray-700/40 hover:bg-slate-300/20
                      hover:text-white transition-colors duration-200
                      ease-linear flex items-center justify-center"
          >
            <a href="https://github.com/aisyahnabillah" target="_blank" rel="noopener noreferrer" className="flex items-center">
              <BiLogoGithub className="mr-4 w-6 h-6" />
              Github
            </a>
          </Button>

{/*          <Button className="bg-black/30 w-full p-6 text-gray-300
          border border-gray-700/40 hover:bg-slate-300/20
          hover:text-white transition-colors duration-200
          ease-linear">

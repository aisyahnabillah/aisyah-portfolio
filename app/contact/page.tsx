...
{/*              <div className="space-y-4">
                ...
                <form action="" className="space-y-4">
                  <div className="space-y-2">
                    ...
                    border border-gray-700/50 bg-black/40 focus:outline-none
                  ...
                  <div className="space-y-2">
                    ...
                    placeholder="Your Message" className="w-full p-2 rounded-lg flex items-center gap-3
                    border border-gray-700/50 bg-black/40 focus:outline-none
                    focus:ring-2 focus:ring-emerald-500 transition-all duration-300"></textarea>
                  </div>
